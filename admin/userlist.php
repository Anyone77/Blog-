          ...
          <div class="card">
            ...
            <?php 
                ...
                if(empty($_POST['search']) && empty($_COOKIE['search'])){
                  ...
                  $sql = $pdo->prepare("SELECT * FROM users ORDER BY id DESC LIMIT $offSet,$numOfRecs ");
                  $sql->execute();
                  $result = $sql->fetchAll();
                }else{
                  $searchKey = $_POST['search'] ? $_POST['search'] : $_COOKIE['search'];

                  $sql = $pdo->prepare("SELECT * FROM users WHERE name LIKE '%$searchKey%' ORDER BY id DESC");
                  $sql->execute();
                  $rawResult = $sql->fetchAll();
                  $total_pages = ceil(count($rawResult) / $numOfRecs );

                  $sql = $pdo->prepare("SELECT * FROM users WHERE name LIKE '%$searchKey%' ORDER BY id DESC LIMIT $offSet,$numOfRecs ");
                  $sql->execute();
                  $result = $sql->fetchAll();
                }
            ...
            <div class="card-body">
              <div>
                <a href="adduser.php" class="btn btn-success" type="button">Create New User</a><br/>
              </div>
              <br/>
